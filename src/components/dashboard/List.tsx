...
const ListItem = ({
  ...
  return (
    <div className='card relative flex h-full w-full flex-col items-start justify-start gap-y-4  rounded-md bg-base-300 p-4 shadow-lg hover:bg-base-200 hover:shadow-2xl'>
      {getRandomIcon()}
